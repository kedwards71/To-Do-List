                        ...
                        {filteredComments.map((c, index) => {
                            return (
                                <Toast key={index} onClose={()=>{
                                    ...
                                    if (selectedTask.owner_id === user.id || c.commenter_id === user.id){
                                        handleCommentDelete(c);
                                    } else {
                                        alert("You cannot delete this comment because you are not the task list owner and you did not leave the comment.")
                                    }
                                }}>
                                    <Toast.Header>
